...
static const sh2_SensorConfig_t StabilityClassifierConfigSpec =
        {true, true, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t StepDetectorConfigSpec =
        {true, false, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t StepCounterConfigSpec =
        {true, false, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t PressureConfigSpec =
        {false, false, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t AmbientLightConfigSpec = {true,
                                                          true,
                                                          false,
                                                          false,
                                                          false,
                                                          ...
                                                          0,
                                                          0,
                                                          0}; // change sensitivity is wrong.
static const sh2_SensorConfig_t TemperatureConfigSpec =
        {true, true, false, false, false, (uint16_t)(0.1 * (2 ^ 7)), 0, 0, 0};
static const sh2_SensorConfig_t HumidityConfigSpec =
        {true, true, false, false, false, (uint16_t)(0.1 * (2 ^ 8)), 0, 0, 0};
static const sh2_SensorConfig_t ProximityConfigSpec =
        {true, true, true, true, false, (uint16_t)(1.0 * (2 ^ 4)), 0, 0, 0};
static const sh2_SensorConfig_t TapDetectorConfigSpec =
        {true, false, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t ShakeDetectorConfigSpec =
        {true, false, true, true, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t FlipDetectorConfigSpec =
        {true, false, true, true, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t StabilityDetectorConfigSpec =
        {true, false, false, false, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t SleepDetectorConfigSpec =
        {true, true, true, true, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t TiltDetectorConfigSpec =
        {true, false, true, true, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t PocketDetectorConfigSpec =
        {true, false, true, true, false, 0, 0, 0, 0};
static const sh2_SensorConfig_t CircleDetectorConfigSpec =
        {true, false, true, true, false, 0, 0, 0, 0};
